...
Case and point: ActiveRecord::Bases don't exist in reality – I've never seen one walking down the street. So <code>ActiveRecord::Base</code>, in my opinion, is a pseudo class.
